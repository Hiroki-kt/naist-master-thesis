...
実験の様子を\figref{app_exp_multi_env}に示す。

\begin{figure}[tb]
    \centering
    \subfigure[200×400 2plate]{\includegraphics[width=0.7\linewidth]{images/fig_sample.png}}
    \label{fig:app_exp_multi_env_same}
    \subfigure[200×400 1plate, 100×200 1plate]{\includegraphics[width=0.7\linewidth]{images/fig_sample.png}}
